...
<nav class="flex justify-end w-full">
	<a class="pr-2 pl-2 pt-2 pb-2 text-sm text-gray-400 md:text-lg hover:scale-110" href="./"
		>Journey</a
	>
...
<Deck>
	...
	<Slide>
		<div class="flex flex-wrap justify-evenly items-center mx-auto max-w-22/24 pt-20">
			<div class="lg:w-11/24 w-22/24 animate__animated animate__fadeInLeft">
				<lottie-player
			...
			<div class="lg:w-11/24 w-22/24 animate__animated animate__fadeInUp">
				...
				<p class="font-sans font-light text-l text-gray-500 mt-8 leading-relaxed">
					Cognitive neuroscience is the research field that studies the biological processes and
	...
	<Slide>
		<div class="flex flex-wrap justify-evenly mx-auto max-w-22/24 pt-20">
			<div class="xl:w-11/24 w-22/24">
				...
				<p class="font-sans font-light text-l text-gray-500 mt-8 leading-relaxed">
					Usually, neuroscientists first define a research question (e.g. how do the background
			...
			<div class="xl:w-11/24 w-22/24">
				<div class="flex flex-wrap justify-evenly items-top mx-auto max-w-22/24">
					...
					>
						<div class="i-openmoji-magnifying-glass-tilted-right mt-6 text-5xl" />
						<h2
	...
	<Slide>
		<div class="flex flex-col min-h-screen items-center justify-center md:w-9/10 w-10/10 mx-auto">
			<p class="font-sans font-bold text-sm text-blue-600 tracking-widest uppercase">Method</p>
			<h1 class="font-sans font-black text-neutral-900 text-4xl mt-8 tracking-tighter">
			...
			>
				...
				<div class="flex flex-col">
					...
					<p class="font-sans font-normal text-lg text-gray-500 mt-8 leading-relaxed">
						We want to study major visual cortical areas in the brain and how they operate when
			...
			>
				<div class="flex flex-col">
					...
					<p class="font-sans font-normal text-lg text-gray-500 mt-8 leading-relaxed">
						To understand the function of different brain regions, we use a neuroimaging technique,
	...
	<Slide>
		<div class="flex flex-wrap justify-evenly items-center mx-auto max-w-22/24 pt-20">
			<div class="xl:w-10/24 w-22/24">
				...
				<p class="font-sans font-light text-l text-gray-500 mt-8 leading-relaxed">
					This is what the data looks like. Please click on the visualization to activate the
			...
			<div class="lg:w-12/24 w-22/24 animate__animated animate__zoomIn">
				<Vizzu
					options={[
						(chart) => {
							chart.animate({
	...
	<Slide>
		<div class="flex flex-wrap justify-evenly items-center mx-auto max-w-22/24 pt-20">
			<div class="lg:w-11/24 w-22/24">
				...
				<p class="font-sans font-light text-l text-gray-500 mt-8 leading-relaxed">
					A fundamental challenge for cognitive and systems neuroscience is to quantitatively relate
		...
		<div class="flex flex-wrap justify-evenly items-center mx-auto max-w-22/24 pt-20 mb-8">
			<div
				class="lg:w-7/24 w-7/24 justify-left op0 start-1:op100 animate__animated start-1:animate__fadeInLeft"
			>
			...
			<div class="lg:w-8/24 w-8/24">
				...
				>
					Even in the subproblem of the visual processing, here are various mechanisms and
				...
				>
					From the perception to cognition, there are also more layers of subtlety, such as the
					attention mechanisms and contextual information in real world scenarios.
				</p>
			</div>

			<div
				class="lg:w-8/24 w-8/24 mb-8 op0 start-1:op100 animate__animated start-2:animate__fadeInRight"
			>
