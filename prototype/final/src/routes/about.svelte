...
<nav class="flex justify-end w-full">
	...
	<a class="pr-2 pl-2 pt-2 pb-2 text-sm text-gray-300 md:text-lg hover:scale-110" href="./beyond"
		>Beyond</a
	>
	<a class="pr-2 pl-2 pt-2 pb-2 text-sm text-gray-400 md:text-lg hover:scale-110" href="./about"
		>?</a
	>
</nav>

<svelte:head>
	<title>Brain Experience | About</title>
</svelte:head>
...
<Deck>
	<Slide>
		<div class="flex flex-col min-h-screen justify-center">
			...
			<p class="font-sans font-normal  max-w-4/6 mx-auto leading-relaxed">
				<br />
				<br />
				Created by Columbia University neuroscientist
				<b><a href="https://www.baihan.org/">Baihan Lin</a></b>, <i>Brain Experience</i> is an
				...
				<br />
				<br />
				As the <b>Research Topics</b>, this project will <br />
				<br />&bull; introduce the foundations of the perception process of the brains with visual
				storytelling and
				<br />&bull; visualize the dynamic process of how different brain regions interact to
				perform these cognitive tasks,

				<br />
				<br />
				The <b>Research Significance</b> is to guide the readers understand how the human brains
				process information in an organized, systematic and hierarchical way, so that they can:

				<br />
				<br />&bull; have a knowledge of the underlying mechanisms when they perform daily tasks;
				<br />&bull; gain access to one of the research frontiers in the fields of cognitive and
				computational neuroscience;
				<br />&bull; come up with new research questions and pursue a scientific research;
				<br />&bull; build better neural network structures inspired by these neuroscientific
				discoveries; and
				<br />&bull; revisit their philosophical stances of life about how our consciousness and
				thinking processes are formed.

				<br />
				<br />
				<b>Research Outline</b>

				<img src="research-map.png" alt="research" class="w-150 mx-auto" />

				<br />
				<br />
				<b>Design Outline</b>

				<img src="initial-design.png" alt="design" class="w-150 mx-auto" />

				<br />
				<br />
				<b>Design Wireframe</b>
				<img src="wireframe.png" alt="wireframe" class="w-150 mx-auto" />
