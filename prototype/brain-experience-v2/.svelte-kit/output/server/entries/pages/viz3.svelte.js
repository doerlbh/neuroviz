...
let smallNums = [
  ...
  ...new Array(28).fill([0.0142, 0.0142, 95e-4, 95e-4, 95e-4, 95e-4, 47e-4]).flat(),
  ...
  ...new Array(28).fill([0.0189, 0.0252, 0.0189, 0.0126, 0.0126, 0.0126, 63e-4]).flat(),
...
let hugeNums = smallNums.map((x) => Math.floor(x * rand() * 1e9));
...
var viz3_svelte_svelte_type_style_lang = "";
const css = {
  code: "#vizzuCanvas.svelte-psti65{width:680px;height:446px}",
  map: null
};
const Viz3 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  new Vizzu("vizzuCanvas");
  $$result.css.add(css);
  return `<div class="${""}"><div id="${"vizzuCanvas"}" class="${"svelte-psti65"}"></div>
</div>`;
});
export { Viz3 as default };
